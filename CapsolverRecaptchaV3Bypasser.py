...
class CapsolverRecaptchaV3Bypasser:
    ...
    def solve_recaptcha(self):
        ...
        self.webdriver.execute_script(f"document.getElementsByClassName('g-recaptcha-response')[0].value = '{self.solution['gRecaptchaResponse']}';")
        time.sleep(.1)